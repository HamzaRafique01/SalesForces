...
String Name_f = 'Object Repository/Home Page/Add New Quota Form/Select Goal'

WebUI.click(findTestObject(Name_f), FailureHandling.STOP_ON_FAILURE)

WebUI.enableSmartWait()

String Name_ff = 'Object Repository/Home Page/Add New Quota Form/search goal'
...
String Name_fff = 'Object Repository/Home Page/Add New Quota Form/Click on searched item Goal'

WebUI.click(findTestObject(Name_fff), FailureHandling.STOP_ON_FAILURE)

WebUI.enableSmartWait()

String Name_ffff = 'Object Repository/Home Page/Add New Quota Form/click on save after selecting Goal'

WebUI.click(findTestObject(Name_ffff), FailureHandling.STOP_ON_FAILURE)

WebUI.enableSmartWait()

//WebUI.click(findTestObject(Name_ffff))
